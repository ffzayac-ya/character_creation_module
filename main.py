...
# Глобальные константы величины дефолтной атаки и защиты.
DEFAULT_ATTACK = 5
DEFAULT_DEFENCE = 10
DEFAULT_STAMINA = 80
...
class Character:
    ...
    # Константа описания класса персонажа.
    BRIEF_DESC_CHAR_CLASS = 'отважный любитель приключений'
    # Константа для диапазона очков урона.
    RANGE_VALUE_ATTACK = (1, 3)
    # Константа для диапазона значения защиты.
    RANGE_VALUE_DEFENCE = (1, 5)
    # Константа для названия специального умения.
    SPECIAL_SKILL = 'Удача'
    # Константа для значения очков урона от спец. умения.
    SPECIAL_BUFF = 15
    # Константа для значения выносливости.
...
def start_training(character: Character):
    ...
    welcome_phrases = {'Warrior': 'ты Воитель — великий мастер ближнего боя.',
                       'Mage': 'ты Маг — превосходный укротитель стихий.',
                       'Healer': 'ты Лекарь — чародей, способный исцелять раны.'}
    print(f'{character.name}, {welcome_phrases[character.__class__.__name__]}')
